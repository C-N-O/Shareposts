<?php require APPROOT . '/views/includes/header.php'; ?>
    <a href="<?php echo URLROOT;  ?>/posts/index" class="btn btn-dark"><i class="fa fa-backward"></i> Back To Posts</a>
    <div class="card card-body bg-light mt-5">
        <h2>Edit Post</h2>
        <p>Edit Your Post and Submit.</p>
        <form action="<?php echo URLROOT; ?>/posts/edit/<?php echo $data['id']; ?>" method="post">
            ...
            <div class="form-group">
                ...
                echo empty($data['body_err']) ? '' : 'is-invalid'; ?>"><?php echo $data['body']; ?></textarea>
